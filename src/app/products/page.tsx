      ...
      <main className="pt-24 px-4 lg:px-[max(60px,(100vw-1200px)/2)] pb-20">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <p className="text-[18px] text-[rgba(255,255,255,0.6)] leading-[1.6] max-w-3xl">
            Atlassian apps that solve real problems, plus venture studio opportunities for innovative teams.
          </p>
        </div>
        
        {/* Products Section */}
        <div className="mb-20">
          <h2 className="font-montserrat text-[32px] font-bold text-white mb-10">Applications</h2>
              ...
              <Link key={index} href={product.href} className="glass rounded-2xl p-8 hover:bg-[rgba(78,205,196,0.05)] hover:border-[rgba(78,205,196,0.3)] hover:translate-y-[-4px] transition-all no-underline block">
                ...
                <div className="flex flex-wrap gap-3">
                  {product.tags.map((tag, i) => (
                    <span key={i} className="text-[12px] text-[rgba(255,255,255,0.35)] flex items-center gap-1">
                      {tag}
                    </span>
                  ))}
                </div>
        ...
        {/* Ventures Section */}
        <div>
          <h2 className="font-montserrat text-[32px] font-bold text-white mb-10">Venture Studio</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7 max-w-5xl mx-auto">
